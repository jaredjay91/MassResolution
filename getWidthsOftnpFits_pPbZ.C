...
void getWidthsOftnpFits_pPbZ(int RD0MC1=0) {
  TString RDorMC;
  ...
  c1->SaveAs(Form("Results/MassResZpPb%s.pdf",RDorMC.Data()));
  ...
  c2->SaveAs(Form("Results/MassScaleZpPb%s.pdf",RDorMC.Data()));

  //Set up the output tree.
  TString outFileName = Form("Results/MassResZpPb%s.root",RDorMC.Data());
