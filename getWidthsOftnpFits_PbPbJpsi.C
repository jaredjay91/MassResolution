...
void getWidthsOftnpFits_PbPbJpsi(int RD0MC1=0) {
  TString RDorMC;
  ...
  c1->SaveAs(Form("Results/MassResJpsiPbPb%s.pdf",RDorMC.Data()));
  ...
  c2->SaveAs(Form("Results/MassScaleJpsiPbPb%s.pdf",RDorMC.Data()));

  //Set up the output tree.
  TString outFileName = Form("Results/MassResJpsiPbPb%s.root",RDorMC.Data());
