...
PDFName = "cbGausPassFailPol1" #cbPlusPol1, cbPlusPol2, cbGausPlusPol1, cbGausPlusPol2
...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("tnp_Ana_RD_PbPb_Trg_%s_%s_%sFilter_%s.root" % (filterTag, "mass2834", TagTrg, scenario) ), #"mass2834" for mass range systematics #L3M310QH, L3M12
    ...
    cbGausPassFailPol1 = cms.vstring( #n and alpha fixed to average value from abseta bins in MC 1 Dec 2020
        "CBShape::signal1Pass(mass, mean[3.08,3.00,3.3], sigma1Pass[0.03, 0.01, 0.10], alpha[1.86], n[1.27])",
        "CBShape::signal1Fail(mass, mean, sigma1Fail[0.03, 0.01, 0.10], alpha, n)",
        "RooFormulaVar::sigma2Pass('@0*@1',{fracS[2.06],sigma1Pass})",
