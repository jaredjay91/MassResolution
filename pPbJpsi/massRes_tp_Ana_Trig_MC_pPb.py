...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    ###
    # Both dir:
    InputFileNames = cms.vstring("file:/eos/cms/store/group/phys_heavyions/okukral/TagAndProbe2016/LowPt/tnpJPsi_MC_bothDir_v5_L3Mu3_MuId.root"),
    #InputFileNames = cms.vstring("file:/eos/cms/store/group/phys_heavyions/okukral/TagAndProbe2016/LowPt/Winter2019Files/tnpJPsi_MC_bothDir_v5.root"),#OldFile

    # pPb only:
    #InputFileNames = cms.vstring("file:/eos/cms/store/group/phys_heavyions/okukral/TagAndProbe2016/LowPt/tnpJPsi_MC_pPb_skimmedWeighted_v5_tagL3Mu3.root"),

    # Pbp only:
    #InputFileNames = cms.vstring("file:/eos/cms/store/group/phys_heavyions/okukral/TagAndProbe2016/LowPt/tnpJPsi_MC_Pbp_skimmedWeighted_v5_tagL3Mu3.root"),
    ...
    cbGausExp = cms.vstring(
        "CBShape::signal1(mass, mean[3.08,3.00,3.3], sigma1[0.03, 0.001, 0.10], alpha[1.8, 0.1, 50], n[1.17])",
    ...
    cbGausPassFailExp = cms.vstring( #n fixed to average value from abseta bins in MC May 8, 2020
    ...
    DCBPassFailExp = cms.vstring( #n fixed to average value from abseta bins in MC May 8, 2020
    ...
    DCBPassFailPol1 = cms.vstring( #n fixed to average value from abseta bins in MC May 8, 2020
        "CBShape::signal1Pass(mass, mean[3.08,3.00,3.3], sigma1Pass[0.03, 0.01, 0.10], alpha[1.8, 0.1, 50], n[2.01])",
        "CBShape::signal1Fail(mass, mean, sigma1Fail[0.03, 0.01, 0.10], alpha, n)",
        "RooFormulaVar::sigma2Pass('@0*@1',{fracS[2.0,1.2,2.4],sigma1Pass})",
        "CBShape::signal2Pass(mass, mean, sigma2Pass, alpha, n)",
