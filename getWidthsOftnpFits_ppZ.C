...
void getWidthsOftnpFits_ppZ(int RD0MC1=0) {
  TString RDorMC;
  ...
  c1->SaveAs(Form("Results/MassResZpp%s.pdf",RDorMC.Data()));
  ...
  c2->SaveAs(Form("Results/MassScaleZpp%s.pdf",RDorMC.Data()));

  //Set up the output tree.
  TString outFileName = Form("Results/MassResZpp%s.root",RDorMC.Data());
