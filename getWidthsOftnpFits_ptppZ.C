...
void getWidthsOftnpFits_ptppZ() {
  ...
  TFile* f1 = TFile::Open("ppZ/tnp_Ana_RD_L3Mu12_iso_pp_nominal_0.root","READ");
  ...
  c2->SaveAs("ptMassScaleZpp.pdf");

  //Set up the output tree.
  TString outFileName = "ptMassResZpp.root";
