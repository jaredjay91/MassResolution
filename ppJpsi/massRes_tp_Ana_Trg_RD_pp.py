...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    InputFileNames = cms.vstring("file:/eos/cms/store/group/phys_heavyions/gfalmagn/tnpJpsi_pp5TeVRun2017G_PromptReco_20190924_SingleMuTnP_and_SingleMu_NoDuplicates_wAddedFlags.root"),
    InputDirectoryName = cms.string("tpTree"),
    InputTreeName = cms.string("fitter_tree"),
    OutputFileName = cms.string("file:tnp_fitOutput_Trigger_data_pp_CBGPlusPol1_separateBarrel_Jared.root"),
