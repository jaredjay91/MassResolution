...
void getWidthsOftnpFits_ptPbPbZ(int RD0MC1=0) {
  TString RDorMC;
  ...
  cout << "starting loop" << endl;
   for (int i=0; i<numbins; i++) {
     ...
     //RooFitResult* fitRes = (RooFitResult*)f1->Get(Form("tpTree/Trg_abseta21_24/abseta_bin0__pt_bin%i__tag_hiBin_bin0__isTightMuon_true__BWConvCBExpFixedWidthBW/fitresults;1",i));
     RooFitResult* fitRes = (RooFitResult*)f1->Get(Form("tpTree/Trg_pt/eta_bin0__pt_bin%i__tag_hiBin_bin0__isTightMuon_true__BWConvCBExpFixedWidthBW/fitresults;1",i));
  ...
  c1->SaveAs(Form("Results/ptMassResZPbPb%s.pdf",RDorMC.Data()));
  ...
  c2->SaveAs(Form("Results/ptMassScaleZPbPb%s.pdf",RDorMC.Data()));

  //Set up the output tree.
  TString outFileName = Form("Results/ptMassResZPbPb%s.root",RDorMC.Data());
