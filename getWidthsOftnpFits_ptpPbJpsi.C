...
void getWidthsOftnpFits_ptpPbJpsi(int RD0MC1=0) {
  TString RDorMC;
  ...
  double ptbins[8] = {1.3, 1.6, 2.2, 3.0, 5.5, 12.0, 25.0, 50.0};
  ...
  c1->SaveAs(Form("Results/ptMassResJpsipPb%s.pdf",RDorMC.Data()));
  ...
  c2->SaveAs(Form("Results/ptMassScaleJpsipPb%s.pdf",RDorMC.Data()));

  //Set up the output tree.
  TString outFileName = Form("Results/ptMassResJpsipPb%s.root",RDorMC.Data());
