...
void getWidthsOftnpFits_PbPbJpsi(TString RDorMC="MC") {
  ...
  TString filename = Form("PbPbJpsi/tnp_Ana_%s_PbPb_Trg_L3Jpsi_cbPlusPol1_TagMu3Filter.root",RDorMC.Data());
  ...
  cout << "starting loop" << endl;
   for (int i=0; i<numbins; i++) {
     ...
     TString fitResPath;
     if (RDorMC=="RD") fitResPath = Form("tpTree/Trg_centdep/eta_bin0__pt_bin0__tag_hiBin_bin%i__InAcceptance_2018_Tight_true__isHybridSoftMuon2018_true__isUnprescaled_true__tag_HLT_HIL3Mu5_NHitQ10_true__cbPlusPol1/fitresult_simPdf_data_binned;1",i);
     else if (RDorMC=="MC") fitResPath = Form("tpTree/Trg_centdep/eta_bin0__pt_bin0__tag_hiBin_bin%i__InAcceptance_2018_Tight_true__isHybridSoftMuon2018_true__tag_HLT_HIL3Mu5_NHitQ10_true__cbPlusPol1/fitresult_simPdf_data_binned;1",i);
