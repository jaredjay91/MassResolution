...
void getWidthsOftnpFits_etaPbPbJpsi(int RD0MC1=0) {
  TString RDorMC;
  ...
  TString filename;
  if (RDorMC=="MC") filename = "PbPbJpsi/mine/tnp_Ana_MC_PbPb_Trg_L3Jpsi_cbGausPassFailPol1_TagMu5Filter_4.root";
  else if (RDorMC=="RD") filename = "PbPbJpsi/mine/tnp_Ana_RD_PbPb_Trg_L3Jpsi_mass2834_TagMu5Filter_4.root";
  ...
  cout << "starting loop" << endl;
   for (int i=0; i<numbins; i++) {
     ...
     TString fitResPath;
     if (RDorMC=="MC") fitResPath = Form("tpTree/Trg_absetadep/abseta_bin%i__pt_bin0__InAcceptance_2018_Tight_true__isHybridSoftMuon2018_true__tag_HLT_HIL3Mu5_NHitQ10_true__cbGausPassFailPol1/fitresults;1",i);
     else if (RDorMC=="RD") fitResPath = Form("tpTree/Trg_absetadep/abseta_bin%i__pt_bin0__InAcceptance_2018_Tight_true__isHybridSoftMuon2018_true__isUnprescaled_true__tag_HLT_HIL3Mu5_NHitQ10_true__cbGausPassFailPol1/fitresults;1",i);
  ...
  c1->SaveAs(Form("Results/etaMassResJpsiPbPb%s.pdf",RDorMC.Data()));
  ...
  c2->SaveAs(Form("Results/etaMassScaleJpsiPbPb%s.pdf",RDorMC.Data()));

  //Set up the output tree.
  TString outFileName = Form("Results/etaMassResJpsiPbPb%s.root",RDorMC.Data());
